...
.macro PrintText value
    ...
    lda #<value       tab      ; Load Lo Byte to Acc.
...
PleaseMakeAGuessTXT:
    .byte "please make a guess (0-255)?"
    BRK

Congratulations_TEXT:
    .byte "congratulations, you guessed correctly, and only took "
    BRK
...
CarrySet_TEXT:
    .byte "your number is too high"
    .byte 13
    BRK

CarryClear_TEXT:
    .byte "your number is too low"
    .byte 13
    BRK

GuessAttempts_TEXT:
    .byte "that was guess number "
    BRK
;*******************************************************************************
;* Code                                                                        *
Start:
...
SorryYourGuessToLow:CHR_Return
